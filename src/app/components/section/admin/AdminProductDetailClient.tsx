...
import {ArrowLeft, Edit3, Image as ImageIcon, Layers3, Sparkles, Tag} from "lucide-react";
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="max-w-2xl text-base leading-7 text-base-content/70 lg:text-lg">
                                Inspect the preview, review the pricing tiers, and update the product from the editor on the same page.
                            </p>
                        </div>
                        ...
                        <tbody>
                            {product.variants.map((variant) => (
                                <tr key={`${variant.type}-${variant.license}`}>
                                    ...
                                    <td>
                                        {IMAGE_VARIANTS[variant.type].dimensions.width} x {IMAGE_VARIANTS[variant.type].dimensions.height}px
                                    </td>
                                </tr>
                            ))}
                        </tbody>
